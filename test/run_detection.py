...
def run_detection(name):
    file = 'C:\\Users\\Tejasvi\\Desktop\\darknet-master\\build\\darknet\\x64\\'
    # print("1")
    # os.system("copy " + name + file)
    # print("a")
    # os.chdir(os.path.dirname("C:\\Users\\Tejasvi\\Desktop\\CP493\\GoWithTheFlow\\test"))
    # print("b")
    # os.system("C:\\Users\\Tejasvi\\Desktop\\CP493\\GoWithTheFlow\\test\\script.sh")
    # print("a")
    # os.system("rd " + file + "video.mp4")
    # print("b")
    # os.system("move output_00000100.jpg ..")
    # print("a")
    # os.system("rd outp*")
    # print("b")
    # os.system("move \\output_00000100.jpg .")
    # print("a")
    # os.system("move output_00000100.jpg test_img.jpg")
    # print("b")
    os.system("cd C:\\Users\\Tejasvi\\Desktop\\darknet-master\\build\\darknet\\x64\\results")
    for c in 45:
        os.system("copy frame%d test_img.jpg"%c)


        (centers, ends, y_vals), (s_centers, starts, sy_vals), paths = perform_localization()
        shape = draw_path(paths)
        #run_detection()
    #os.chdir(os.path.dirname("C:\\Users\\Tejasvi\\Desktop\\CP493\\GoWithTheFlow\\test\\run_detection.py"))
